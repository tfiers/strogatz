...
\img[0.5]{phase_space_10000}
\img[0.5]{phase_space_11000} \\[0.3em]
\captionn{Phase space diagrams for different predator-decay rates $\bm{c}$}{Fixed points are indicated with colored dots. Their manifolds of attraction are given the same color. The limit cycle for $0.446... = c_h < c < 0.55$, and its basin of attraction, are indicated in purple.}
